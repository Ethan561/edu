      ...
      <van-swipe-item v-for="(a, i) in list" :key="a.id">
        <div class="item">
          ...
          <div class="quesItem">
            ...
            <!-- 1单选 -->
            <van-radio-group v-if="a.type == 1" v-model="a.single_choice.answer">
              <van-radio
            ...
            <!-- 2判断 -->
            <van-radio-group v-if="a.type == 2" v-model="a.judge.answer">
              <van-radio
            ...
            <!-- 3多选 -->
            <van-checkbox-group v-if="a.type == 3" v-model="a.multiple_choice.answer">
              <van-checkbox
            ...
            <!-- 4填空 -->
            <div v-if="a.type == 4" v-html="a.blanks.content"></div>
            <!--5 简答 -->
            <van-field
              v-if="a.type == 5"
              v-model="a.qa"
            ...
            <div v-if="a.type == 7" class="sorts">
              <div v-for="(b, j) in a.sorts" :key="b.id" class="sorts-item flex-between">
            ...
            <ul v-if="a.type == 8" class="scales">
              <li v-for="(b, i) in a.scales" :key="i" class="scales-item">
                <p class="scales-item__title">{{ b.title }}</p>
                <van-rate :count="b.maxScore" v-model="b.score" />
              </li>
            </ul>
            ...
            <!-- 10 下拉测试 -->
            <div v-if="a.type == 10">
              <select @change="seletedChoice(a)" v-model="a.pull_choice.answer" class="pull_choice">
            ...
            <div v-if="a.type == 11">
              <div class="juzhenxuanze">
                <table>
                  <tr>
                    <td></td>
                    <td v-for="(b, j) in a.ju_choice.rows" :key="j">{{ b }}</td>
                  </tr>
                  <tr v-for="(b, j) in a.ju_choice.cols" :key="j">
                    <td>{{ b }}</td>
                    <td v-for="(c, n) in a.ju_choice.answers[j]" :key="n">
                      <input type="checkbox" @change="checkJzxe(a.ju_choice.answers[j], n)" />
                    </td>
                  </tr>
                </table>
              </div>
            ...
            <ul v-if="a.type == 12" class="scales">
              <li v-for="(b, j) in a.scale_fill" :key="j" class="scales-item flex-between">
                <p class="scales-item__title">{{ b.title }}</p>
                <input style="width:50%" class="juzhentk" v-model="b.answer" type="text" />
              </li>
            </ul>
            <!-- 13 自增表格 -->
          ...
          <div class="quesFooter">
            ...
            <van-button
              ...
              @click="nextQes(a, i)"
            >下一题</van-button>
            <van-button v-if="i == list.length - 1" @click="save" color="#176095" type="info">提交</van-button>
          </div>
        </div>
      </van-swipe-item>
    </van-swipe>
