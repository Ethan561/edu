  ...
  <div ref="Box">
    ...
    <div v-if="desBoxShow" class="desBox">
      ...
      <div class="flex-center">
        <van-button color="#176095" @click="startAnswer()" type="info"
          >开始答题</van-button
        >
      </div>
    </div>
  ...
  methods: {
    ...
    getData() {
      HTTP_Accurate(this.$route.query.qid).then((res) => {
        ...
        console.log(
          "compare time: ",
          this.compareDate(this.desData.start, datefmt())
        );
      });
    },
    ...
    compareDate(date1, date2) {
      // var beginTime = "2009-09-25 00:00:00";
