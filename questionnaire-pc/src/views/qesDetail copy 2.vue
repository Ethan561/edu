<template>
  <div>
    ...
    <van-overlay :show="answerSheet" @click="answerSheet = false">
      <div class="wrapper flex-center">
        <ul class="answerList">
          <li v-for="(a, i) in list" :class="{active:answerIndex==i}" :key="a.id" @click="jump(i)">{{i+1}}</li>
        </ul>
      </div>
    </van-overlay>
    <div class="desBox">
      ...
      <van-swipe-item v-for="(a, i) in list" :key="a.id">
        <div class="item">
          ...
          <div class="quesItem">
            ...
            <div class="flex-start" v-if="a.type == 6">
...
import mockjs from "@/assets/mock.js";
import {
  HTTP_Accurate,
  HTTP_AccurateSave,
  HTTP_Uploads,
