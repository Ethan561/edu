 ...
 * @LastEditors: liuyi
 * @LastEditTime: 2023-06-12 15:09:35
 * @FilePath: \questionnaire-template-master\src\http\interface.js
 * @Description: 
 */
...
/* 精准提交 */
export const HTTP_AccurateSave = (id, write, action, api_token = Session.get(apiTokenKey)) => req('/api/index/save', {
  api_token,
  id,
  write,
  action
...
export const HTTP_AccurateSaveAll = (id, write, action, api_token = Session.get(apiTokenKey)) => req('/api/index/save', {
  api_token,
  id,
  write,
  action
...
/* 精准提交 */
export const HTTP_AccurateOpenSave = (id, write) => req('/api/index/opensave', {
  id,
  write
}, { method: 'POST', loading: { show: false } })
/* 用户信息 */
